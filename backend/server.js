...
app.post('https://frontend-1-sage.vercel.app/api/appointments', (req, res) => {
...
app.get('https://frontend-1-sage.vercel.app/api/appointments', (req, res) => {
  res.json(readAppointments());
});

app.patch('https://frontend-1-sage.vercel.app/api/appointments/:id', (req, res) => {
...
app.delete('https://frontend-1-sage.vercel.app/api/appointments/:id', (req, res) => {
...
app.listen(PORT, () => {
  console.log(`${CLINIC_NAME} server running at https://frontend-1-sage.vercel.app:${PORT}`);
});
