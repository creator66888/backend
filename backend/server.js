...
// CREATE APPOINTMENT
app.post('frontend-1-sage.vercel.app/api/appointments', (req, res) => {
...
// GET APPOINTMENTS
app.get('frontend-1-sage.vercel.app/api/appointments', (req, res) => {
  res.json(readAppointments());
});


// UPDATE APPOINTMENT
app.patch('frontend-1-sage.vercel.app/api/appointments/:id', (req, res) => {
...
// DELETE APPOINTMENT
app.delete('frontend-1-sage.vercel.app/api/appointments/:id', (req, res) => {
...
app.listen(PORT, () => {
  console.log(`${CLINIC_NAME} server running on port frontend-1-sage.vercel.app ${PORT}`);
});